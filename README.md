...
This has no bearing on anything; such entries will have a [valid Contentful ID](https://www.contentful.com/developers/docs/references/content-management-api/#/introduction/resource-ids), in the format  `cfimp.*`.
